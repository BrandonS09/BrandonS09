...
- An event hosting and joining website where users can create, host, or join events and recieve emails sent out by the hosts for further details, current code [here](https://github.com/BrandonS09/Event-Host-Join-Website)
